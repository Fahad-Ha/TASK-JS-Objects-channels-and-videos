...
function channelHasVideo(videoTitle, channel) {
  // Your code here
  // videoTitle = channel.videos;
  // videoTitle.some(videoTitle);
  // videoTitle.some((item) => vi);
  // const videoExist = channel.videos.find((video) =>
  //   video["title"].includes(videoTitle)
  // );
  // if (videoExist) return videoExist;
  // return false;

  return channel.videos.some((title) => title["title"] === videoTitle);
}
...
function getChannelByName(channelName, channels) {
  // Your code here
  return channels.find((chan) => chan.name === channelName);
}
